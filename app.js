...
function isViewAuthorized(viewId) {
    ...
    // Security Users (Security Gatekeeper, Front Desk Operator, Gatekeeper, Security)
...
window.editLiveRegistration = function (id, category) {
    ...
    if (category === "student") {
        ...
        const sc = document.getElementById("reg-student-company"); if (sc) sc.value = visitor.studentCompany || "";
        ...
        const ci = document.getElementById("reg-customer-id"); if (ci) ci.value = visitor.masterId || "";
        ...
        const vi = document.getElementById("reg-vendor-visitor-id"); if (vi) vi.value = visitor.masterId || "";
